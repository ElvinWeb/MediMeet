    ...
    <div className="min-h-screen py-10">
      ...
      <main className="w-full mx-auto bg-white rounded-md shadow-lg px-8 py-10">
        <p className="mb-6 text-md text-gray-500">
          <strong className="text-gray-700">Last Updated:</strong> May 13, 2025
        </p>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside space-y-1 text-gray-700">
            <li>
              <strong>Personal Info:</strong> Name, email, phone, date of birth.
            </li>
            <li>
            ...
            <li>
              <strong>Technical Info:</strong> IP address, browser type, device
              data.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            We may share your data with healthcare providers, service partners,
            or authorities when legally required. We do not sell your data.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            We use encryption, secure servers, and internal policies to protect
            your data. However, no system is completely immune to threats.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            MediMeet is not designed for children under 13. We do not knowingly
            collect data from minors without consent.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700">
            We may update this policy. Please review it regularly. Changes will
            be reflected on this page with the date above.
          </p>
        </section>
